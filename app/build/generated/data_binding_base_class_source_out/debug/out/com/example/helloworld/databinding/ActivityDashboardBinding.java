...
public final class ActivityDashboardBinding implements ViewBinding {
  ...
  private ActivityDashboardBinding(@NonNull ScrollView rootView,
      ...
      @NonNull MaterialButton logoutButton, @NonNull MaterialButton myProfileButton,
  ...
  public static ActivityDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDashboardBinding((ScrollView) rootView, animationsButton, anrCrashButton,
          dragDropButton, featuresTitleTextView, generateErrorsButton, hitApisButton, logoutButton,
          myProfileButton, scrollButton, settingsButton, userDetailsTextView, userInfoTextView,
